...
const Testimonial = () => {
  ...
  return (
    ...
    >
      {/* Decorative elements */}
      <div className="absolute top-0 left-0 w-full h-12 bg-forest-green/10 -z-10"></div>
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-pale-straw/5 rounded-full -ml-32 -mb-16 -z-10"></div>
      
      {/* Section header */}
      <FadeIn direction="up" className="text-center mb-12">
        <span className="text-pale-straw text-xl md:text-2xl font-serif">Testimonials</span>
        <h2 className="text-3xl md:text-4xl text-pale-straw font-semibold mb-4 mt-2 font-clash">What Our Travelers Say</h2>
      ...
      <div className="max-w-5xl mx-auto">
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="relative">
                    <svg className="text-forest-green opacity-20 w-16 h-16 absolute -top-6 -left-6" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" />
                    </svg>
                    <blockquote className="text-lg text-deep-forest/80 mb-6 z-10 relative">
                      {testimonials[activeIndex].content}
                    </blockquote>
                  </div>

                  <div className="mt-8 border-t pt-4 border-moss-green/20">
                    <p className="font-semibold text-forest-green text-lg font-clash">
        ...
        <div className="flex justify-between items-center mt-8">
          <button
            onClick={handlePrev}
            className="flex items-center justify-center w-12 h-12 rounded-full bg-forest-green text-pale-straw hover:bg-deep-forest transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
