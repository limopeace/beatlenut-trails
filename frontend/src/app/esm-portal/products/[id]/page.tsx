...
const MOCK_PRODUCTS = [
  ...
  },
  {
    ...
    seller: {
      ...
      about: 'After serving in the Indian Army, I returned to my family's tradition of tea cultivation. Our tea gardens in Darjeeling are managed with the same precision and care that I learned during my military career.',
      ratings: 4.7,
      totalSales: 243,
      contactInfo: {
    ...
    userReviews: [
      ...
      },
      {
        ...
        rating: 5,
        date: '2023-05-15',
        comment: 'As a tea connoisseur, I can say this is some of the finest tea I've had. The fact that it supports our veterans makes it even more special!'
      }
    ],
